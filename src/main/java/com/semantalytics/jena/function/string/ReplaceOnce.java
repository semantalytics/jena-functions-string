...
public final class ReplaceOnce extends FunctionBase3 {

    public static final String name = StringVocabulary.replaceOnce.stringValue();
    ...
    public NodeValue exec(final NodeValue arg0, final NodeValue arg1, final NodeValue arg2) {
        ...
        return makeString(replaceOnce(string, searchString, replacement));
    }
}
