...
public final class LastIndexOfAny extends FunctionBase {
    ...
    public static final String name = StringVocabulary.lastIndexOfAny.stringValue();
    ...
    public NodeValue exec(final List<NodeValue> args) {
        ...
        final String[] searchStrings = args.stream().skip(1).map(NodeValue::asString).toArray(String[]::new);

        return makeInteger(lastIndexOfAny(string, searchStrings));
    }
