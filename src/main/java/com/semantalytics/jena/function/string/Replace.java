...
public final class Replace extends FunctionBase3 {

    public static final String name = StringVocabulary.replace.stringValue();
    ...
    public NodeValue exec(final NodeValue arg0, final NodeValue arg1, final NodeValue arg2) {
        ...
        return makeString(replace(string, searchString, replacement));
    }
}
