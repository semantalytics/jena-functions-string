...
public final class ReplaceChars extends FunctionBase3 {

    public static final String name = StringVocabulary.replaceChars.stringValue();
    ...
    public NodeValue exec(final NodeValue arg0, final NodeValue arg1, final NodeValue arg2) {
        ...
        return makeString(replaceChars(string, searchString, replacement));
    }
}
