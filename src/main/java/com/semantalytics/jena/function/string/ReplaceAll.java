...
public final class ReplaceAll extends FunctionBase3 {

    public static final String name = StringVocabulary.replaceAll.stringValue();
    ...
    public NodeValue exec(final NodeValue arg0, final NodeValue arg1, final NodeValue arg2) {
        ...
        return makeString(replaceAll(string, searchString, replacement));
    }
}
